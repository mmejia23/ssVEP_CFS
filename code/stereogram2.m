function [SX, DX] = stereogram2(A,varargin)
...
if strcmp(varargin, 'crossed-eyes')
    view_type = 'crossed-eyes';
else
    view_type = 'parallel-eyes';
end
...
if strcmp(varargin, 'plot')
    ...
    set(gcf,'NumberTitle','off','name','Stereogram - by I.-G. Marino')
