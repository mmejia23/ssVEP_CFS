function [data, expmnt] = ssvepCFS(subject, suppression, supp_alpha)
% Info
% 
% Pending:
...
if nargin > 1
    expmnt.this_trial__mask_alpha   = supp_alpha;
else
    switch suppression
        case 0
            expmnt.this_trial__mask_alpha   = 0.05;
        case 1
            expmnt.this_trial__mask_alpha   = 0.15;
    end
end
...
this_trial__mask_alpha = expmnt.this_trial__mask_alpha;
